...
#Input file paths for your MMSeqs2 .tsv file, training data fasta, and testing data fasta
MMSEQSresults = '75.tsv'
...
df = pd.read_csv(MMSEQSresults, sep='\t', header=None)
...
for level in range(2, 7):
    ...
    # Compute completeness, homogeneity, and V-measure
