...
VSEARCH_RESULTS_PATH = 'temp/members.cd-hit'
TRAIN_FASTA_PATH = 'RDP/RDPtraining.fasta'
TEST_FASTA_PATH = 'RDP/RDPtest.fasta'
...
df = parse_cdhit_clstr(VSEARCH_RESULTS_PATH)
...
with open(TRAIN_FASTA_PATH) as f:
